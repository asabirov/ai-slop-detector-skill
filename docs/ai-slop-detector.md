...
| id | Level | Severity | Tell |
|----|-------|----------|------|
| `comment-chaptered` | 1 | error | A document of 8+ comment lines with an interior divider or a shouted section heading. |
...
headings and interior dividers are counted across the blocks. Dividers framing
an individual block remain frames; joining does not turn them into chapters.
